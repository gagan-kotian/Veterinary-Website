...
import "./kankanawadi.css"; // Assuming you have a CSS file for styling
  ...
  return (
    <div className="wrapper">
      ...
      <div className="details">
        <h1 className="h1">ಪ್ರಾಥಮಿಕ ಪಶು ಚಿಕಿತ್ಸಾಲಯ ಕಂಕಣವಾಡಿ</h1>
